...
public class CreditBalanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview=inflater.inflate(R.layout.fragment_credit_balance, container, false);

        databasecredit_ref= FirebaseDatabase.getInstance().getReference().child("CreditData");
        databasecredit_ref.keepSynced(true);
        recyclerView=(RecyclerView)myview.findViewById(R.id.recyclercredit_xml);
